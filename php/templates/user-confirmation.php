...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:4px;overflow:hidden;">
  ...
  <tr>
    <td style="padding:30px 30px 20px;">
      <p style="margin:0 0 16px;font-size:16px;color:#333;">Hey, <?= $e($data['name']) ?>!</p>

      <p style="margin:0 0 16px;font-size:14px;color:#444;line-height:1.6;">Thank you for contacting DJ Misha! I would be honored to provide the music experience at your event.</p>

      <p style="margin:0 0 16px;font-size:14px;color:#444;line-height:1.6;">When you have a moment, please reply and let me know your musical vision for your event - I would love to know!</p>

      <p style="margin:0 0 16px;font-size:14px;color:#444;line-height:1.6;">For booking requests, please feel free to elaborate on any additional details for your event: occasion, date, time, location, venue and approximate people in attendance.</p>

      <p style="margin:0 0 16px;font-size:14px;color:#444;line-height:1.6;">DJ Misha responds to booking inquiries by text (sms), usually within a few minutes or when he next checks his phone.</p>

      <p style="margin:0 0 16px;font-size:14px;color:#444;line-height:1.6;">DJ Misha and saxophone players are available for private bookings, weddings and corporate events including national and international travel.</p>

      <p style="margin:0 0 16px;font-size:14px;color:#444;line-height:1.6;">Thank you - I look forward to hearing back from you!</p>

      <p style="margin:0 0 20px;font-size:14px;color:#444;">xoxo,<br>DJ Misha</p>
    </td>
  </tr>

  <tr>
    <td style="padding:0 30px 20px;">
      <img src="https://djmisha.com/images/logo-djmisha.png" width="150" alt="DJ Misha" style="display:block;margin-bottom:16px;" />
    </td>
  </tr>

  <tr>
    <td style="padding:0 30px 20px;font-size:14px;color:#444;line-height:1.8;">
  ...
  <tr>
    <td style="padding:0 30px 30px;font-size:14px;color:#444;line-height:1.8;">
